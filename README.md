...
Response mode flow:
@728px: 
- the grid is displayed in column.

@420px:
- Main heading size goes down to 1.5rem;
- .btn anchor gest white-space: nowrap to prevent "Sign up" text to go two lines.

  
Other:
I added "transition: all 0.5s ease-out" at hover .btn.

Known bugs:
Not optimized for resolutions smaller than 375px.
